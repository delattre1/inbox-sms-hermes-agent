# Inbox SMS -- imagem do agente, derivada da base cloud da Plow.
#
...
COPY LICENSE NOTICE /usr/share/doc/inbox-sms/
...
COPY ib-setup/            /opt/hermes/skills/ib-setup/
COPY ib-triage/           /opt/hermes/skills/ib-triage/
COPY ib-digest/           /opt/hermes/skills/ib-digest/
COPY ib-reply/            /opt/hermes/skills/ib-reply/
COPY ib-shared/           /opt/hermes/skills/ib-shared/
...
COPY ib-shared/ /opt/plow/ib-shared/
